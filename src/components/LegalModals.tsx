...
function ModalShell({ title, children, onClose }: { title: string; children: React.ReactNode; onClose: () => void }) {
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative bg-white rounded-2xl w-full max-w-2xl max-h-[85vh] flex flex-col shadow-xl border border-slate-200">
...
export function PrivacyModal({ onClose }: ModalProps) {
  ...
  return (
    <ModalShell title={t('privacy_title')} onClose={onClose}>
      <p className="text-slate-400 text-xs">{t('privacy_updated')}</p>

      <section>
        <h3 className="text-slate-900 font-semibold mb-1">1. Datos que recopilamos</h3>
      ...
      <section>
        <h3 className="text-slate-900 font-semibold mb-1">2. Uso de los datos</h3>
      ...
      <section>
        <h3 className="text-slate-900 font-semibold mb-1">3. Almacenamiento y seguridad</h3>
      ...
      <section>
        <h3 className="text-slate-900 font-semibold mb-1">4. Cookies</h3>
      ...
      <section>
        <h3 className="text-slate-900 font-semibold mb-1">5. Tus derechos</h3>
      ...
      <section>
        <h3 className="text-slate-900 font-semibold mb-1">6. Contacto</h3>
...
export function TermsModal({ onClose }: ModalProps) {
  ...
  return (
    <ModalShell title={t('terms_title')} onClose={onClose}>
      <p className="text-slate-400 text-xs">{t('terms_updated')}</p>

      <section>
        <h3 className="text-slate-900 font-semibold mb-1">1. Aceptación de los términos</h3>
        <p>Al usar LocalSEOHub aceptas estos términos. Si no estás de acuerdo, no debes utilizar el servicio.</p>
      </section>

      <section>
        <h3 className="text-slate-900 font-semibold mb-1">2. Descripción del servicio</h3>
      ...
      <section>
        <h3 className="text-slate-900 font-semibold mb-1">3. Cuenta de usuario</h3>
      ...
      <section>
        <h3 className="text-slate-900 font-semibold mb-1">4. Suscripción y pagos</h3>
      ...
      <section>
        <h3 className="text-slate-900 font-semibold mb-1">5. Uso aceptable</h3>
      ...
      <section>
        <h3 className="text-slate-900 font-semibold mb-1">6. Limitación de responsabilidad</h3>
      ...
      <section>
        <h3 className="text-slate-900 font-semibold mb-1">7. Contacto</h3>
...
export function ContactModal({ onClose }: ModalProps) {
  ...
  return (
    <ModalShell title={t('contact_title')} onClose={onClose}>
      <p className="text-slate-500">{t('contact_desc')}</p>
